...
\
\cf4 $sql\cf3  = 
\f0\b \cf5 "SELECT id, notes AS description, status FROM requests WHERE status = 'pending'"
\f1\b0 \cf3 ;\
...
\f0\b \cf4 echo
\f1\b0 \cf3  \cf6 json_encode(\cf4 $requests\cf3 );\

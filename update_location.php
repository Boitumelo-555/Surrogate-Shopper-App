...
\
\cf4 $email\cf3  = \cf4 $_POST\cf3 [
\f0\b \cf5 'email'
\f1\b0 \cf3 ];\
\cf4 $latitude\cf3  = \cf4 $_POST\cf3 [
\f0\b \cf5 'latitude'
\f1\b0 \cf3 ];\
\cf4 $longitude\cf3  = \cf4 $_POST\cf3 [
\f0\b \cf5 'longitude'
\f1\b0 \cf3 ];\
\
\cf4 $query\cf3  = 
\f0\b \cf5 "UPDATE users SET latitude='$latitude', longitude='$longitude' WHERE email='$email'"
\f1\b0 \cf3 ;\
\cf4 $result\cf3  = \cf6 mysqli_query(\cf4 $link\cf3 , \cf4 $query\cf3 );\
\

\f0\b \cf4 if
\f1\b0 \cf3  (\cf4 $result\cf3 ) \{\

...
\f0\b \cf5 "message"
\f1\b0 \cf3  => 
\f0\b \cf5 "Database connection error"
\f1\b0 \cf3 ]);\
    \cf6 exit(\cf3 );\
\}\
\
\cf4 $request_id\cf3  = \cf6 intval(\cf4 $_GET\cf3 [
\f0\b \cf5 'request_id'
\f1\b0 \cf3 ] ?? 0);\
\

\f0\b \cf4 if
\f1\b0 \cf3  (\cf4 $request_id\cf3  <= 0) \{\
...
\f0\b \cf5 "message"
\f1\b0 \cf3  => 
\f0\b \cf5 "Invalid Request ID"
\f1\b0 \cf3 ]);\
    \cf6 exit(\cf3 );\
\}\
\
\cf4 $query\cf3  = 
\f0\b \cf5 "SELECT name, quantity FROM items WHERE request_id = $request_id"
\f1\b0 \cf3 ;\
...
\f1\b0 \cf3  (\cf4 $row\cf3  = \cf6 mysqli_fetch_assoc(\cf4 $result\cf3 )) \{\
    \cf4 $items\cf3 [] = \cf4 $row\cf3 ;\
\}\
\

\f0\b \cf4 echo
\f1\b0 \cf3  \cf6 json_encode(\cf4 $items\cf3 );\
\
\cf6 mysqli_close(\cf4 $link\cf3 );\
